...
document.getElementById("addForm").addEventListener("submit", function (e) {
  ...
  saveSuggestion("printStyleSuggestions", styleInput);
  saveSuggestion("printColors_" + style, colorInput);
...
loadSuggestions("printStyleSuggestions", "styleSuggestions");

document.getElementById("style").addEventListener("change", function () {
  const style = this.value.trim().toLowerCase();
  loadSuggestions("printColors_" + style, "colorSuggestions");
});
