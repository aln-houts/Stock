...
function generateInvoice() {
  ...
  document.getElementById('preview-project-name').textContent = document.getElementById('project-name').value;
  document.getElementById('preview-payment-status').textContent = document.getElementById('payment-status').value;
  document.getElementById('preview-due-date').textContent = document.getElementById('due-date').value;
  document.getElementById('preview-issue-date').textContent = document.getElementById('issue-date').value;
